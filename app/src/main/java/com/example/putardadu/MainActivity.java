...
public class MainActivity extends AppCompatActivity {
    ...
    private void gantiGambar() {
      ...
      //Mengeset Gambar dengan Drawable Baru + diacak
    ...
    private void melemparDadu() {
        ...
        if (txtView.getText().equals("6")) {
            txtView.setText("6");
            Toast.makeText(MainActivity.this, "Maximal", Toast.LENGTH_SHORT).show();
            
        }else {
            txtView .setText(angka);
            Toast.makeText(MainActivity.this, "Belum Maximal", Toast.LENGTH_SHORT).show();
